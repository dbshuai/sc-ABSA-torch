...
class IAN(nn.Module):
    def __init__(self, embedding_matrix, opt):
        ...
        self.lstm_context = DynamicRNN(opt.embed_dim, opt.hidden_dim, num_layers=1, batch_first=True)
        self.lstm_aspect = DynamicRNN(opt.embed_dim, opt.hidden_dim, num_layers=1, batch_first=True)
